...
namespace PeliculasAPI.Tests.PruebasUnitarias
{
    ...
    public class PeliculasControllerTests:BasePruebas
    {
        ...
        [TestMethod]
        public async Task FiltrarOrdenarTitulosAscendente()
        {
            var nombreDB = CrearDataPrueba();
            var mapper = ConfigurarAutoMapper();
            var contexto = ConstruirContext(nombreDB);
            ...
            CollectionAssert.AreEqual(peliculasDb.Select(x => x.Id).ToList(), peliculas.Select(x=> x.Id).ToList());
        }

        [TestMethod]
        public async Task FiltrarOrdenarTitulosDescendente()
        {
            var nombreDB = CrearDataPrueba();
            var mapper = ConfigurarAutoMapper();
            var contexto = ConstruirContext(nombreDB);
        ...
        [TestMethod]
        public async Task FiltrarPorCampoIncorrecto()
        {
            var nombreDB = CrearDataPrueba();
            var mapper = ConfigurarAutoMapper();
            var contexto = ConstruirContext(nombreDB);
