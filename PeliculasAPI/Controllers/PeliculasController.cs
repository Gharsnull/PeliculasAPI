...
namespace PeliculasAPI.Controllers
{
    ...
    public class PeliculasController: CustomBaseController
    {
        ...
        public async Task<ActionResult<List<PeliculaDTO>>> Filtrar([FromQuery] FiltroPeliculasDTO filtroPeliculasDTO)
        {
            ...
            if (filtroPeliculasDTO.EnCines) peliculasQueryable = peliculasQueryable.Where(x => x.EnCines);

            if(filtroPeliculasDTO.ProximosEstrenos) peliculasQueryable = peliculasQueryable.Where(x=> x.FechaEstreno > DateTime.Today);
