...
namespace PeliculasAPI.Helpers
{
    ...
    {
        public AutoMapperProfiles(GeometryFactory geometryFacotry)
        {
            ...
            CreateMap<SalaDeCineDTO, SalaDeCine>()
                .ForMember(x=> x.Ubicacion, x=> x.MapFrom(y=> geometryFacotry.CreatePoint(new Coordinate(y.Longitud, y.Latitud))));
        ...
        private List<GeneroDTO> MapearPeliculasGeneros(Pelicula pelicula, PeliculaDetallesDTO peliculaDetallesDTO)
        {
